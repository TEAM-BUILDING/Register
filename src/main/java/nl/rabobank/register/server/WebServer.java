    ...
    private HandlerCollection createHandlers() {
        ...
        _ctx.setConfigurations(new Configuration[] { new AnnotationConfiguration() {
            ...
            public void configure(WebAppContext context) throws Exception {
                ...
                // Even if metadata is complete, we still need to scan for ServletContainerInitializers - if there are
                // any
                AnnotationParser parser = null;
                if (!metadataComplete) {
                    // If metadata isn't complete, if this is a servlet 3 webapp or isConfigDiscovered is true, we need
                ...
                // Regardless of metadata, if there are any ServletContainerInitializers with @HandlesTypes, then we
                // need to scan all the
                ...
                for (Resource _resource : _resources) {
                    ...
                    parser.parse(_resource, new ClassNameResolver() {
                        ...
                        public boolean shouldOverride(String name) {
                            // looking at webapp classpath, found already-parsed class of same name - did it come from
                            // system or duplicate in webapp?
